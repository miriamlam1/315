...
nonABS:
 sub $t1, $a3, $a1
>>>>>>> f2da0c89166b2c8ec87c4cb7d4030a129c149fa1
abs: addi $t3, $0, 1 
slt $t2, $t0, $t1 
bne $t2, $0, else
add $t3, $0, $0
...
addi $t5, $0, -1
<<<<<<< HEAD
startLoop: add $t6, $0, $a0 
addi $t7, $a2, 1
lloop: beq $t6, $t7, endLine 
beq $t3, $0, plotXY
plotYX: sw $t4, 0($sp)
sw $t6, 1($sp)
addi $sp, $sp, 2
...
addi $t7, $t1, 1
<<<<<<< HEAD
circleStart: beq $t0, $t7, circleEnd 
=======
circleStart:
 beq $t0, $t7, circleEnd 
>>>>>>> f2da0c89166b2c8ec87c4cb7d4030a129c149fa1
