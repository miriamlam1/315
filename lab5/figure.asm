...
#abs's
    #t0 = 
    sub $t0, $a3, $a1 #t0 = y1-y0 
    slt $t2, $t0, $0 #if (y1-y0) < 0, t2 =1 
    beq $t2, $0, skip1 #if t2 = 0 skip (already pos)
    sub $t0, $0, $t0 # t0 = -(y1-y0)
skip1:
    #t4 = 
    sub $t1, $a2, $a0 #t1 = x1-x0 
    slt $t2, $t0, $0  #if (x1-x0) < 0, t4 =1 
    beq $t2, $0, skip2 #if t4 = 0 skip (already pos)
    sub $t4, $0, $t1 #t4 = abs(x1-x0) 
skip2:
# set state = t2
