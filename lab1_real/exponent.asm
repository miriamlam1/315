...
# Section: 315-05
# Description: This program take in two numbers (x,y) and returns the exponentiation (the result after raising x^y).
...
main:
   ...
   beq     $t5, $0, base_case #if exp = 0 go to base_case
