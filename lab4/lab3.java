...
public class lab3
{
    ...
    public static int step()
    {
        ...
        System.out.println("pc: "+line_count+" "+ Arrays.toString(in));
        String op = in[0];
        switch(op)
        {
            case "add":
    ...
    {
        System.out.println("\npc = " + pc +
        "\n$0 = "+0+"          $v0 = "+register[2]+"         $v1 = "+register[3]+"         $a0 = "+register[4] +
        "\n$a1 = "+register[5]+"         $a2 = "+register[6]+"         $a3 = "+register[7]+"         $t0 = "+register[8] +
        "\n$t1 = "+register[9]+"         $t2 = "+register[10]+"         $t3 = "+register[11]+"         $t4 = "+register[12] +
        "\n$t5 = "+register[13]+"         $t6 = "+register[14]+"         $t7 = "+register[15]+"         $s0 = "+register[16] +
        "\n$s1 = "+register[17]+"         $s2 = "+register[18]+"         $s3 = "+register[19]+"         $s4 = "+register[20] +
        "\n$s5 = "+register[21]+"         $s6 = "+register[22]+"         $s7 = "+register[23]+"         $t8 = "+register[24] +
        "\n$t9 = "+register[25]+"         $sp = "+register[29]+"         $ra = "+register[31] +"\n");
    }
